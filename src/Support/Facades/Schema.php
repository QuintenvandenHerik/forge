 ...
 * @method static \Forge\Database\Connection getConnection()
 * @method static \Forge\Database\Schema\Builder setConnection(\Forge\Database\Connection $connection)
 ...
 *
 * @see \Forge\Database\Schema\Builder
 */
