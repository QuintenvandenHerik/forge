...
use Forge\Support\Contracts\DeferringDisplayableValue;
use Forge\Support\Contracts\Htmlable;
use Forge\Database\Eloquent\Model;
use Forge\Support\Arr;
use Forge\Support\Env;
use Forge\Support\Fluent;
use Forge\Support\HigherOrderTapProxy;
use Forge\Support\Once;
use Forge\Support\Onceable;
use Forge\Support\Optional;
use Forge\Support\Sleep;
use Forge\Support\Str;
use Forge\Support\Stringable as SupportStringable;
...
if (! function_exists('e')) {
     ...
     *
     * @param  \Forge\Support\Contracts\DeferringDisplayableValue|\Forge\Support\Contracts\Htmlable|\BackedEnum|string|int|float|null  $value
...
if (! function_exists('optional')) {
     ...
     * @return ($callback is null ? \Forge\Support\Optional : ($value is null ? null : TReturn))
     */
...
if (! function_exists('str')) {
     ...
     * @return ($string is null ? object : \Forge\Support\Stringable)
     */
...
if (! function_exists('tap')) {
     ...
     * @return ($callback is null ? \Forge\Support\HigherOrderTapProxy : TValue)
     */
