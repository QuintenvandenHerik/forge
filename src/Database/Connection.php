...
use Closure;
use Forge\Database\ConnectionInterface;
...
abstract class Connection implements ConnectionInterface
{
	 ...
	 *
	 * @var \PDO|\mysqli|\Closure
	 */
	protected $connection;
	
	/**
	 * The active connection used for reads.
	 *
	 * @var \PDO|\mysqli|\Closure
	 */
	 ...
	 *
	 * @var \Forge\Database\Query\Grammars\Grammar
	 */
	 ...
	 *
	 * @var \Forge\Database\Query\Processors\Processor
	 */
	 ...
	 *
	 * @var \Forge\Contracts\Events\Dispatcher|null
	 */
	protected $events;
	 ...
	 *
	 * @var \Forge\Database\DatabaseTransactionsManager|null
	 */
	 ...
	 * @param  array  $config
	 */
	public function __construct($connection, string $database = '', string $tablePrefix = '', array $config = [])
	{
	 ...
	 *
	 * @return \Forge\Database\Query\Grammars\Grammar
	 */
	 ...
	 *
	 * @return \Forge\Database\Schema\Grammars\Grammar|null
	 */
	 ...
	 *
	 * @return \Forge\Database\Query\Processors\Processor
	 */
	 ...
	 *
	 * @return \Forge\Database\Schema\Builder
	 */
	 ...
	 *
	 * @param  \Closure|\Forge\Database\Query\Builder|ExpressionContract|string  $table
	 * @param  string|null  $as
	 *
	 * @return \Forge\Database\Query\Builder
	 */
	 ...
	 * @param  bool  $useReadConnection
	 * @return mixed
	 */
	public function selectOne($query, $bindings = [], $useReadConnection = true)
	{
		$records = $this->select($query, $bindings, $useReadConnection);
	 ...
	 * @return mixed
	 *
	 * @throws \Forge\Database\MultipleColumnsSelectedException
	 */
	public function scalar($query, $bindings = [], $useReadConnection = true)
	{
		$record = $this->selectOne($query, $bindings, $useReadConnection);
	 ...
	 * @return array
	 */
	public function select($query, $bindings = [], $useReadConnection = true)
	{
		return $this->run($query, $bindings, function ($query, $bindings) use ($useReadConnection) {
			if ($this->pretending()) {
				return [];
			}
			...
			$statement = $this->prepared(
				$this->getConnectionForSelect($useReadConnection)->prepare($query)
			);
	 ...
	 * @return array
	 */
	public function selectResultSets($query, $bindings = [], $useReadConnection = true)
	{
		return $this->run($query, $bindings, function ($query, $bindings) use ($useReadConnection) {
			if ($this->pretending()) {
				return [];
	 ...
	 */
	public function cursor($query, $bindings = [], $useReadConnection = true)
	{
		$statement = $this->run($query, $bindings, function ($query, $bindings) use ($useReadConnection) {
			if ($this->pretending()) {
				return [];
			}
			...
			$statement = $this->prepared($this->getConnectionForSelect($useReadConnection)
				->prepare($query));
	 ...
	 * @return \PDO
	 */
	protected function getConnectionForSelect($useReadConnection = true)
	{
		return $useReadConnection ? $this->getReadConnection() : $this->getConnection();
	}
	...
	public function unprepared($query)
	{
		return $this->run($query, [], function ($query) {
			...
			$this->recordsHaveBeenModified(
				$change = $this->getConnection()->exec($query) !== false
			);
	 ...
	 * @return mixed
	 *
	 * @throws \Forge\Database\QueryException
	 */
	 ...
	 *
	 * @param \Forge\Database\QueryException  $e
	 * @param  string  $query
	 * @param  array  $bindings
	 * @param  \Closure  $callback
	 *
	 ...
	 * @return mixed|false
	 *
	 * @throws \Forge\Database\LostConnectionException
	 */
	...
	{
		$this->setConnection(null)->setReadConnection(null);
	}
	...
	{
		return $this->getReadConnection()->quote($value);
	}
	...
	public function getReadConnection()
	{
		...
		return $this->readConnection ?: $this->getConnection();
	}
	 ...
	 * @return \PDO|\Closure|null
	 */
	public function getRawReadConnection()
	{
	 ...
	 *
	 * @param  \PDO|\Closure|null  $connection
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @param \Forge\Database\Query\Grammars\Grammar  $grammar
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @return \Forge\Database\Schema\Grammars\Grammar
	 */
	 ...
	 *
	 * @param \Forge\Database\Schema\Grammars\Grammar  $grammar
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @param \Forge\Database\Query\Processors\Processor  $processor
	 *
	 * @return $this
	 */
	 ...
	 *
	 * @return \Forge\Contracts\Events\Dispatcher
	 */
	 ...
	 *
	 * @param  \Forge\Contracts\Events\Dispatcher  $events
	 * @return $this
	 */
	 ...
	 *
	 * @param  \Forge\Database\DatabaseTransactionsManager  $manager
	 *
	 * @return $this
	 */
