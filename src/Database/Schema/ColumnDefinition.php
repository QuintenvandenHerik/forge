 ...
 * @method $this generatedAs(string|ExpressionContract $expression = null) Create a SQL compliant identity column (PostgreSQL)
 ...
 * @method $this storedAs(string|ExpressionContract $expression) Create a stored generated column (MySQL/PostgreSQL/SQLite)
 ...
 * @method $this virtualAs(string|ExpressionContract $expression) Create a virtual generated column (MySQL/PostgreSQL/SQLite)
 */
