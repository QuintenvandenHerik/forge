...
abstract class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Forge\Database\Schema\Blueprint  $blueprint
     ...
     *
     * @param  \Forge\Database\Schema\Blueprint  $blueprint
     * @param  \Forge\Database\Schema\ColumnDefinition  $column
     * @return string
     */
     ...
     *
     * @param  \Forge\Support\Fluent  $column
     * @return string
     */
     ...
     * @param  \Forge\Database\Schema\Blueprint  $blueprint
     * @param  string  $name
     * @return \Forge\Support\Fluent|null
     */
