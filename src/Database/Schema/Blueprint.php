...
class Blueprint implements BlueprintInterface
{
	 ...
	 *
	 * @var \Forge\Database\Schema\ColumnDefinition[]
	 */
	protected $columns = [];
	 ...
	 *
	 * @var \Forge\Database\Schema\BlueprintState|null
	 */
	protected $state;
	 ...
	 *
	 * @param  \Forge\Database\Connection  $connection
	 * @param  string  $table
	 ...
	 *
	 * @param  array  $names
	 * @return \Forge\Support\Collection
	 */
	 ...
	 * Indicate that the given foreign key should be dropped.
	 *
	 * @param  \Forge\Database\Eloquent\Model|string  $model
	 ...
	 * @return \Forge\Database\Schema\IndexDefinition
	 */
	 ...
	 * @param  string|array  $columns
	 * @param  string|null  $name
	 * @return \Forge\Database\Schema\ForeignKeyDefinition
	 */
	 ...
	 *
	 * @param  string  $column
	 * @return \Forge\Database\Schema\ColumnDefinition
	 */
	 ...
	 *
	 * @param  string  $column
	 * @return \Forge\Database\Schema\ForeignIdColumnDefinition
	 */
	 ...
	 *
	 * @param  int|null  $precision
	 * @return \Forge\Support\Collection<int, \Forge\Database\Schema\ColumnDefinition>
	 */
	 ...
	 *
	 * @param  \Forge\Database\Schema\ColumnDefinition  $definition
	 * @return \Forge\Database\Schema\ColumnDefinition
	 */
	 ...
	 *
	 * @return \Forge\Database\Schema\BlueprintState
	 */
