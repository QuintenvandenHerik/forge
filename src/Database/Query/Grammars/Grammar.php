...
namespace Forge\Database\Query\Grammars;
...
use Forge\Database\Query\Builder;
use Forge\Database\Query\JoinClause;
use Forge\Database\Query\JoinLateralClause;
...
class Grammar extends BaseGrammar
{
     ...
     *
     * @param  \Forge\Database\Query\Builder  $query
     * @return string
     */
     ...
     *
     * @param  \Forge\Database\Query\Builder  $query
     * @param  array{function: string, columns: array<\Forge\Contracts\Database\Query\Expression|string>}  $aggregate
     * @return string
     */
     ...
     *
     * @param  \Forge\Database\Query\JoinLateralClause  $join
